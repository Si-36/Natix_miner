...
class SweepThresholdsSpec(StepSpec):
    ...
    def run(self, ctx: StepContext) -> StepResult:
        ...
        # Build CSV content
        csv_lines = ["threshold,accuracy,acceptance_rate,fnr,tnr,tpr,fpr,ece,brier,tp,fp,tn,fn,precision,recall,f1_score,correct,total"]
    ...
    def _compute_ece(self, probs: torch.Tensor, labels: torch.Tensor, preds: torch.Tensor, n_bins: int = 10) -> float:
        """
